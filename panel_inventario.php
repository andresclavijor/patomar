...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <?php
            ...
            if ($var == "clie-reg") {
                echo '<div class="row" >
                        <div class="alert alert-success" role="alert">Producto Creada.</div>
                    </div>';
            }
        ?>
        ...
        <div class="row">
                <div class="panel-edicion col-lg-10 col-sm-12">
                    ...
                    <div class="options-users col-lg-6 col-sm-6 col-xs-12" style="text-align:right;">
                        ...
                        <div class="btn-group">
                            <a class="btn btn-danger" href="form_productos.php" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Publicar Encuesta">
